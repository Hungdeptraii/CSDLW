...
<div class="container">
    ...
    <div class="table-container">
        ...
        if ($result === false) {
            ...
            echo "<table>";
            echo "<tr><th>ID</th><th>UserName</th><th>Address</th><th>PhoneNumber</th><th>OrderID</th><th>Toltal Price(Đ)</th></tr>";
            if ($result->num_rows > 0) {
                while($row = $result->fetch_assoc()) {
                    ...
                    echo "<td>" . number_format($row["GiaTriDonHang"], 0, '.', ',') . " VNĐ</td>";

                    echo "<td>" . $row["GiaTriDonHang"] . " VNĐ</td>";
...
ORDER BY
    ...
    if ($result === false) {
        ...
        if ($result->num_rows > 0) {
            echo "<table>";
            echo "<tr><th>Products</th><th>Year</th><th>Month</th><th>Revenue(Đ)</th></tr>";
            while ($row = $result->fetch_assoc()) {
                echo "<tr>";
